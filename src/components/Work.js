...
const workData = [
  {
    img: "img/projects/ajmanone.png",
    name: "Ajman One",
    format: "img",
    project: "Mobile Application",
    client: "Ajman Digital Government",
    duration: "3 MONTHS",
    technologies: ["React Native,", " Typescript,", " IBM MFP,", " Strapi,", " MongoDB,", " Redux,", " REST APIs,", " GraphQL"],
    budget: "1550 USD",
    appstore: "https://apps.apple.com/ae/app/ajmanone/id1163528416",
    playstore: "https://play.google.com/store/apps/details?id=com.Ajec&hl=en&gl=US",
  },
  {
    img: "img/projects/rest.png",
    name: "Dubai REST",
    format: "img",
    project: "Mobile Application",
    client: "Dubai Land Department",
    duration: "3 MONTHS",
    technologies: ["React Native,", " Typescript,", " Redux,", " REST APIs,", " Firebase Analytics,", " Appcenter Codepush"],
    budget: "1550 USD",
    appstore: "https://apps.apple.com/us/app/dubai-rest/id1437805105",
    playstore: "https://play.google.com/store/apps/details?id=ae.gov.dubailand.selfregistration&hl=en&gl=US"
  },
  {
    img: "img/projects/simsari.png",
    name: "Simsari",
    format: "img",
    project: "Mobile Application",
    client: "Dubai Land Department",
    ...
    technologies: ["React Native,", " Typescript,", " Redux,", " REST APIs,", " Firebase Analytics,", " Appcenter Codepush"],
    budget: "1550 USD",
    appstore: "https://apps.apple.com/us/app/simsari/id1441243917",
    playstore: "https://play.google.com/store/apps/details?id=ae.gov.dubailand.simsari&hl=en&gl=US"
  },
  // {
  //   img: "img/projects/ajmanone.png",
  //   name: "Image Format",
        ...
        {workData.map((work, i) => (
          ...
          >
            ...
            <div className="projects-info row">
              ...
              <div>
                <a href={work.playstore} className="btn" target="_blank" rel="noreferrer">
                  <span>
                    <i className="fa fa-external-link" />
                    playstore
                  </span>
                </a>
                <a href={work.appstore} className="btn" target="_blank" rel="noreferrer">
                  <span>
                    <i className="fa fa-external-link" />
                    appstore
                  </span>
