    ...
    <section id="home" className={`${nav === "home" ? "active" : ""}`}>
      ...
      <div className="main-text-container">
        {/* <img
          ...
          src={`${leftImgSrc ? leftImgSrc : "img/home_background.png"}`}
          alt=""
        /> */}
        {/* {video && (
        ...
        <div className="main-text" id="selector">
          ...
          <AnimationText />
          <p>
            {`I'm`} a Mobile Application Developer based in Dubai,
            UAE. I strives to build immersive and beautiful mobile applications
