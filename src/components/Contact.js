...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (from_name.length === 0 || reply_to.length === 0 || message.length === 0) {
      ...
      emailjs
        .send(
          "service_gxjh63f", // service id
          "template_lovgoko", // template id
          mailData,
          "68N5yOMHsn0OMoels" // public api
        )
        .then(
          (response) => {
            setError(false);
        ...
        <div className="container">
          <div className="row contact">
              ...
              <ul className="custom-list">
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">+971-507467251</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">id.sohrabhussain@gmail.com</span>
                  </h6>
                </li>
                {/* <li>
                  <h6 className="font-weight-600">
              ...
              <div className="social">
                ...
                <ul className="list-inline social social-intro text-center p-none">
                  <li className="linkedin">
                    <a title="LinkedIn" href="https://www.linkedin.com/in/sohrab-hussain-1b00b518/" target="_blank" rel="noreferrer">
            ...
            <div className="col-12 col-md-8 col-xl-8 rightside">
              <p>
                If you have any suggestion, job opportunity or even you want to say
